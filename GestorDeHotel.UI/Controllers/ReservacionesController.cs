    ...
    public class ReservacionesController : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:44339/api/Reservaciones");
        ...
        public async Task<IActionResult> ObtenerIdDeReservacion(Model.ReservacionViewModelCreate laReservacion)
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:44339/api/Reservaciones/ObtenerReserva");
        ...
        {           
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    await httpClient.PostAsync("https://localhost:44339/api/Reservaciones/AgregarReservacion", byteContent);
        ...
        public async Task<IActionResult> Detalles(Model.ReservacionViewModelCreate laReservacion)
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:44339/api/Reservaciones/Detalles?id=" + laReservacion.Id);
        ...
        public async Task<IActionResult> CheckOut(int id, Model.EstadoDeReservacion estadoDeReservacion)
        {
            ...
            if (estadoDeReservacion == Model.EstadoDeReservacion.EnProceso)
            {
                ...
                try
                {
                    ...
                    var response = await httpClient.GetAsync("https://localhost:44339/api/Reservaciones/CheckOut?id=" + id);
