    ...
    public class PromocionesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:44339/api/Promociones");
        ...
        public async Task<IActionResult> Create()
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:44339/api/Promociones/LlenarDropDownList");
        ...
        public async Task<ActionResult> Create(GestorDeHotel.Model.Promociones promociones)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    await httpClient.PostAsync("https://localhost:44339/api/Promociones/", byteContent);
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:44339/api/Promociones/" + id);
        ...
        public async Task<ActionResult> Edit(GestorDeHotel.Model.Promociones promociones)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    await httpClient.PutAsync("https://localhost:44339/api/Promociones", byteContent);
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:44339/api/Promociones/Detalles?id=" + id);
