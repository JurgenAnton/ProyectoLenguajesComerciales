    ...
    public class HabitacionesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:44339/api/Habitacion/ObtenerHabitaciones");
        ...
        public async Task<IActionResult> Create()
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:44339/api/Habitacion/LlenarDropDownList");
        ...
        public async Task<IActionResult> Create(Model.HabitacionViewModelCreate NuevaHabitacion)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    await httpClient.PostAsync("https://localhost:44339/api/Habitacion/AgregarHabitacion", byteContent);
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:44339/api/Habitacion/" + id);
        ...
        public async Task<IActionResult> Editar(Model.HabitacionViewModelCreate HabitacionEditada)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    await httpClient.PutAsync("https://localhost:44339/api/Habitacion/Edit", byteContent);
        ...
        public async Task<IActionResult> Reparar(int id, Boolean reserva)
        {
            try
            {
                ...
                if (id != 0 && reserva == false )
                {
                    ...
                    await httpClient.PutAsync("https://localhost:44339/api/Habitacion/Reparar", byteContent);
        ...
        public async Task<IActionResult> Habilitar(int id)
        {
            try
            {
                ...
                if (id != 0)
                {
                    ...
                    await httpClient.PutAsync("https://localhost:44339/api/Habitacion/Habilitar", byteContent);
        ...
        public async Task<IActionResult> Detalles(int id)
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://localhost:44339/api/Habitacion/Detalles?id=" + id);
