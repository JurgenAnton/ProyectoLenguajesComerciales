    ...
    public class TarifaController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://apipicateclashotel.azurewebsites.net/api/Tarifa");
        ...
        public async Task<ActionResult> Details(int id)
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://apipicateclashotel.azurewebsites.net/api/Tarifa/" + id);
        ...
        public async Task<ActionResult> Create(GestorDeHotel.Model.Tarifa tarifa)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    await httpClient.PostAsync("https://apipicateclashotel.azurewebsites.net/api/Tarifa/", byteContent);
        ...
        public async Task<ActionResult> Edit(GestorDeHotel.Model.Tarifa tarifa)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    await httpClient.PutAsync("https://apipicateclashotel.azurewebsites.net/api/Tarifa", byteContent);
