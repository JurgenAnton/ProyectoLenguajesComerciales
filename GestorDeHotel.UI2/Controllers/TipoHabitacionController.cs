    ...
    public class TipoHabitacionController : Controller
    {
        ...
        public async Task<ActionResult> IndexAsync()
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://apipicateclashotel.azurewebsites.net/api/TipoHabitacion");
        ...
        public async Task<ActionResult> DetailsAsync(int id)
        {
            ...
            try
            {
                ...
                var response = await httpClient.GetAsync("https://apipicateclashotel.azurewebsites.net/api/TipoHabitacion/" + id);
        ...
        public async Task<ActionResult> CreateAsync(Model.TipoHabitacion tipoHabitacion)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    await httpClient.PostAsync("https://apipicateclashotel.azurewebsites.net/api/TipoHabitacion/", byteContent);
        ...
        public async Task<ActionResult> Edit(GestorDeHotel.Model.TipoHabitacion tipoHabitacion)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    await httpClient.PutAsync("https://apipicateclashotel.azurewebsites.net/api/TipoHabitacion", byteContent);
